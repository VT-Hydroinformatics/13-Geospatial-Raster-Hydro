...
```{r}
# define where to save static and interactive maps
filled_breached_plot_interactive_fp <- "./images/filled-breached-plot.html"
filled_breached_plot_static_fp <- "./images/filled-breached-plot.png"
...
filled_breached_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
  tm_scale_bar()+
tm_shape(difference)+
...
filled_breached_plot |> tmap_save(filename=filled_breached_plot_interactive_fp)
filled_breached_plot |> tmap_save(filename=filled_breached_plot_static_fp)
```

::: {#fig-hillshade-plot .captioned-figure}
<img src="./images/filled-breached-plot.png" alt="Filled/Breached plot" width="1000">

Screenshot of filled and breached plot. View the **[interactive map here](./images/filled-breached-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
d8_plot_interactive_fp <- "./images/d8-plot.html"
d8_plot_static_fp <- "./images/d8-plot.png"
...
d8_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(log(d8))+
  tm_raster(style = "cont", palette = "PuOr", legend.show = TRUE, alpha = .5)+
  tm_scale_bar() 

d8_plot |> tmap_save(filename=d8_plot_interactive_fp)
d8_plot |> tmap_save(filename=d8_plot_static_fp)
```

::: {#fig-d8-plot .captioned-figure}
<img src="./images/d8-plot.png" alt="D8 plot" width="1000">

Screenshot of D8 flow plot. View the **[interactive map here](./images/d8-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
dinf_plot_interactive_fp <- "./images/dinf-plot.html"
dinf_plot_static_fp <- "./images/dinf-plot.png"
...
dinf_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(log(dinf))+
  tm_raster(style = "cont", palette = "PuOr", legend.show = TRUE, alpha = 0.5)+
  tm_scale_bar() 

dinf_plot |> tmap_save(filename=dinf_plot_interactive_fp)
dinf_plot |> tmap_save(filename=dinf_plot_static_fp)
```

::: {#fig-dinf-plot .captioned-figure}
<img src="./images/dinf-plot.png" alt="Dinf plot" width="1000">

Screenshot of D infinity flow plot. View the **[interactive map here](./images/dinf-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
twi_plot_interactive_fp <- "./images/twi-plot.html"
twi_plot_static_fp <- "./images/twi-plot.png"
...
twi_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(twi)+
  tm_raster(style = "cont", palette = "PuOr", legend.show = TRUE, alpha = 0.5)+
  tm_scale_bar() 

twi_plot |> tmap_save(filename=twi_plot_interactive_fp)
twi_plot |> tmap_save(filename=twi_plot_static_fp)
```

::: {#fig-twi-plot .captioned-figure}
<img src="./images/twi-plot.png" alt="TWI plot" width="1000">

Screenshot of Topographic Wetness Index (TWI) plot. View the **[interactive map here](./images/twi-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
downslope_twi_plot_interactive_fp <- "./images/downslope-twi-plot.html"
downslope_twi_plot_static_fp <- "./images/downslope-twi-plot.png"
...
downslope_twi_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(twid)+
  tm_raster(style = "cont", palette = "PuOr", legend.show = TRUE, alpha = 0.5)+
  tm_scale_bar() 

downslope_twi_plot |> tmap_save(filename=downslope_twi_plot_interactive_fp)
downslope_twi_plot |> tmap_save(filename=downslope_twi_plot_static_fp)
```

::: {#fig-twi-plot .captioned-figure}
<img src="./images/downslope-twi-plot.png" alt="Downslope TWI plot" width="1000">

Screenshot of Downslope TWI plot. View the **[interactive map here](./images/downslope-twi-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
streams_hillshade_plot_interactive_fp <- "./images/streams-hillshade-plot.html"
streams_hillshade_plot_static_fp <- "./images/streams-hillshade-plot.png"
...
streams_hillshade_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(streams)+
  tm_lines(col = "blue")+
  tm_scale_bar() 

streams_hillshade_plot |> tmap_save(filename=streams_hillshade_plot_interactive_fp)
streams_hillshade_plot |> tmap_save(filename=streams_hillshade_plot_static_fp)
```

::: {#fig-twi-plot .captioned-figure}
<img src="./images/streams-hillshade-plot.png" alt="Streams/Hillshade plot" width="1000">

Screenshot of stream network plotted over hillshade. View the **[interactive map here](./images/streams-hillshade-plot.html)**. 
:::
